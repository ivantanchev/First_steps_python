...
animals = ["Животно", ["Котка", "та", "f"], ["Куче", "то", "n"], ["Жаба", "та", "f"], ["Носорог", "а", "m"],
           ["Хамстер", "а", "m"], ["Пингвин", "а", "m"], ["Костенурка", "та", "f"], ["Таралеж", "а", "m"],
           ["Риба", "та", "f"], ["Полевка", "та", "f"], ["Мишка", "та", "f"], ["Паун", "а", "m"]]
colors = ["Цвят", "Червен", "Син", "Зелен", "Лилав", "Черн", "Жълт", "Оранжев", "Сив", "Кафяв", "Рижав"]
places = ["Място", ["Парк", "а"], ["Море", "то"], ["Океан", "а"], ["Планина", "та"], ["Река", "та"], ["Зала", "та"],
          ["Пързалка", "та"]]
human = ["Човек", ["Печатар", "я"], ["Печатар", "я"], ["Певец", "а"], ["Футболист", "а"], ["Репортер", "а"],
         ["Фермер", "а"]]
verbs = [{"Животно": [["плува", "на воля", "бързо", "непохватно"], ["пие", "вода", "жадно", "рядко"],
                      ["обитава", "предимно", "високо", "под земята"], ["дълбае", "дупки", "тунели", "за храна"],
                      ["ходи", "бавно", "на криво", "изправен"], ["вие", "продължително", "силно", "жално"],
                      ["спи", "зимен сън", "през деня", "дълго"]]}, {
             "Човек": [["плува", "разстояние", "далеч", "на сухо"], ["пие", "течности", "алкохол", "вода"],
                       ["тича", "слепешката", "задъхано", "скоростно"], ["ходи", "пеш", "рядко", "на два крака"],
                       ["простира", "пране", "на голяма площ", "ръцете си"], ["пише", "грозно", "красиво", "рядко"],
                       ["чете", "книги", "фейсбук", "читанка"], ["спи", "малко", "много", "непробудно"]]}]
...
while message.lower() != "не":
    ...
    if being[0] == "Човек":
        ...
        story = f"Когато {being[0].lower()} отиде на {place[0].lower()}, никой не очаква, че {color.lower() + gen_animal} {animal[0].lower()} може да {ver} {how_animal} в {place2[0].lower() + place2[1]}."
    if being[0] == "Животно":
        being = being[random.randrange(1, len(being) - 1)]
